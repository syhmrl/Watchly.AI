        ...
        if frame is not None:
            ...
            for result in results:
                for box in result.boxes:
                    ...
                    # ### CORE RE-ID LOGIC (Only if enabled) ###
                    if self.enable_reidentification:
                        if tracker_id not in self.tracker_id_map:
                            ...
                            if embedding is None:
                                ...
                                print(f"--- Frame {self.frame_idx}: New BoTSORT ID {tracker_id} appeared. Checking {len(self.lost_track_features)} lost tracks. ---")
            ...
            # ### Logic for handling lost tracks (Only if Re-ID is enabled) ###
            if self.enable_reidentification:
