"""
This is a version where the logic of people entering and exiting able
to miscount when there is a slight occlision in the middle of the line
where a person is standing in the middle
"""
